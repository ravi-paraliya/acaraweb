            ...
            <Grid container item spacing={2} xs={12} display={"flex"} justifyContent={"center"} alignItems={"end"}>
              <Grid item xs={12} sm={6} padding={5} display={"flex"}  justifyContent={"center"} alignItems={"center"}>
                <Box display={"flex"} alignItems={"center"} gap={2}>
                   <Link to={"https://www.youtube.com/watch?v=BvbfZqcJ-Zg"}>
              ...
              <Grid item xs={12} sm={6}>
                 <Box>
                    <Typography sx={{fontSize:{lg:"48px",md:"45px",sm:"42px",xs:"39px"},textAlign:"start",fontWeight:"600",color:"white",lineHeight:"60px",fontFamily:"Poppins,sans-serif"}}>The UK’s Best Event Management Agency for Corporate</Typography>
